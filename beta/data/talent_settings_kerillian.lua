...
<meta content="scripts/managers/talents/talent_settings_kerillian.lua · master · Matt / Vermintide 2 Source Code" property="og:title">
...
<meta content="https://gitlab.com/Aussiemon/vermintide-2-source-code/blob/master/scripts/managers/talents/talent_settings_kerillian.lua" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="scripts/managers/talents/talent_settings_kerillian.lua · master · Matt / Vermintide 2 Source Code" property="twitter:title">
...
<title>scripts/managers/talents/talent_settings_kerillian.lua · master · Matt / Vermintide 2 Source Code · GitLab</title>
...
<meta name="csrf-token" content="vk7C+/MPMRj0gS6QAD9wKomGk7zPmJYVWb8zhbldrWHWjOpRb3k5D0TWNkMp2h351q7rLiKwaNDXTo4riJqzUQ==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/Aussiemon/vermintide-2-source-code/blob/master/scripts/managers/talents/talent_settings_kerillian.lua">Repository</a></h2>
</li>
</ul>
</div>
...
<input type="hidden" name="path" id="path" value="scripts/managers/talents/talent_settings_kerillian.lua" />
<div class="dropdown">
...
<li>
<a href="/Aussiemon/vermintide-2-source-code/blob/master/scripts/managers/talents/talent_settings_kerillian.lua"><strong>talent_settings_kerillian.lua</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/Aussiemon/vermintide-2-source-code/blame/master/scripts/managers/talents/talent_settings_kerillian.lua">Blame</a><a class="btn" href="/Aussiemon/vermintide-2-source-code/commits/master/scripts/managers/talents/talent_settings_kerillian.lua">History</a><a class="btn js-data-file-blob-permalink-url" href="/Aussiemon/vermintide-2-source-code/blob/6cd13156b45ac676dc26b2a74e22189844bb4286/scripts/managers/talents/talent_settings_kerillian.lua">Permalink</a></div>
</div>
</div>
...
talent_settings_kerillian.lua
</strong>
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;scripts/managers/talents/talent_settings_kerillian.lua&quot;,&quot;gfm&quot;:&quot;`scripts/managers/talents/talent_settings_kerillian.lua`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><i aria-hidden="true" aria-hidden="true" data-hidden="true" class="fa fa-clipboard"></i></button>
<small>
34.5 KB
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;72213a3ab64ef842d6eb3da5ed536e30598dc9cc&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><i aria-hidden="true" aria-hidden="true" data-hidden="true" class="fa fa-clipboard"></i></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/Aussiemon/vermintide-2-source-code/raw/master/scripts/managers/talents/talent_settings_kerillian.lua"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a></div>
<div class="btn-group" role="group"><span class="btn btn-sm path-lock disabled has-tooltip" data-toggle="tooltip" title="You do not have permission to lock this">Lock</span><button name="button" type="submit" class="btn js-edit-blob  js-edit-blob-link-fork-toggler" data-action="edit" data-fork-path="/Aussiemon/vermintide-2-source-code/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2FAussiemon%2Fvermintide-2-source-code%2Fedit%2Fmaster%2Fscripts%2Fmanagers%2Ftalents%2Ftalent_settings_kerillian.lua&amp;namespace_key=2765683">Edit</button><button name="button" type="submit" class="btn btn-default js-edit-blob-link-fork-toggler" data-action="edit" data-fork-path="/Aussiemon/vermintide-2-source-code/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2F-%2Fide%2Fproject%2FAussiemon%2Fvermintide-2-source-code%2Fedit%2Fmaster%2Fscripts%2Fmanagers%2Ftalents%2Ftalent_settings_kerillian.lua&amp;namespace_key=2765683">Web IDE</button><button name="button" type="submit" class="btn btn-default js-edit-blob-link-fork-toggler" data-action="replace" data-fork-path="/Aussiemon/vermintide-2-source-code/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+replace+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2FAussiemon%2Fvermintide-2-source-code%2Fblob%2Fmaster%2Fscripts%2Fmanagers%2Ftalents%2Ftalent_settings_kerillian.lua&amp;namespace_key=2765683">Replace</button><button name="button" type="submit" class="btn btn-remove js-edit-blob-link-fork-toggler" data-action="delete" data-fork-path="/Aussiemon/vermintide-2-source-code/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+delete+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2FAussiemon%2Fvermintide-2-source-code%2Fblob%2Fmaster%2Fscripts%2Fmanagers%2Ftalents%2Ftalent_settings_kerillian.lua&amp;namespace_key=2765683">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-new" rel="nofollow" data-method="post" href="/Aussiemon/vermintide-2-source-code/blob/master/scripts/managers/talents/talent_settings_kerillian.lua">Fork</a>
...
{"path":"scripts/managers/talents/talent_settings_kerillian.lua","toggle_path":"/Aussiemon/vermintide-2-source-code/path_locks/toggle"}
</script>

<div class="blob-viewer" data-type="simple" data-url="/Aussiemon/vermintide-2-source-code/blob/master/scripts/managers/talents/talent_settings_kerillian.lua?format=json&amp;viewer=simple">
...
<h3 class="page-title">Replace talent_settings_kerillian.lua</h3>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form form-horizontal" data-method="put" action="/Aussiemon/vermintide-2-source-code/update/master/scripts/managers/talents/talent_settings_kerillian.lua" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="P3YRSIHR+rRru40J8Uz7PgUV86HBTUm9hz5/efGV/iBXtDniHafyo9vsldrYqZbtWj2LMyxlt3gJz8LXwFLgEA==" /><div class="dropzone">
...
<label class="control-label" for="commit_message-f12bcce8f4560be12168d3c5a6c889a4">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-f12bcce8f4560be12168d3c5a6c889a4" class="form-control js-commit-message" placeholder="Replace talent_settings_kerillian.lua" required="required" rows="3">
Replace talent_settings_kerillian.lua</textarea>
</div>
</div>
</div>
